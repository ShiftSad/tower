...
//    runtimeOnly("de.fabmax:physx-jni:2.5.1:natives-linux")   // Changed to older version with cuda support
    implementation(files("libs/physx-jni-natives-linux-cuda-2.5.1.jar"))
    implementation(files("libs/physx-jni-natives-windows-cuda-2.5.1.jar"))
